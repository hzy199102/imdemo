<template>
  <div class="layim-chat-footer">
    ...
    <div class="layim-chat-textarea"><textarea id="textarea" @keyup.13="onEnter" v-model="textarea"></textarea></div>
...
<script>
  import fbFace from './fbFace.vue'
  import fbChatLog from './fbChatLog.vue'
  export default {
    props: ['cache'],
    data () {
      return {
...
//        _this.textarea = _this.cache.tempContent[newVal] || ''
    ...
    methods: {
      ...
      onEnter: function (e) {
        var _this = this
        if (_this.cache.local.sendHotKey === 'Enter') {
          if (e.ctrlKey) {
