<template>
  <span id='fbFile_span_file' @click="clickFile" class="gccui-icon" title="发送文件">
    <img src="../../../../assets/file.png" style="width:25px"><input id="fbFile_input_file" type="file" name="file" style="display:none;"></span>
</template>
<script>
  export default {
    props: ['CSInfo'],
    ...
    methods: {
      ...
      clickFile: function () {
        ...
        if (othis.attr('status') === 'disabled') {
          _this.$root.gccer.msg('文件发送中,请稍候...')
          return false
        }
